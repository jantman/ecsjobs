# -*- coding: utf-8 -*-
#
# ecsjobs documentation build configuration file, created by
...
from ecsjobs.version import VERSION
...
html_title = 'v{v} - ECS scheduled job wrapper and reporter'.format(v=version)
...
latex_documents = [
  (master_doc, 'ecsjobs.tex', u'ecsjobs Documentation',
...
man_pages = [
    (master_doc, 'ecsjobs', u'ecsjobs Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ecsjobs', u'ecsjobs Documentation',
   author, 'ecsjobs', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/ecsjobs'
]
