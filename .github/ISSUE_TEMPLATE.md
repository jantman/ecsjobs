...
ecsjobs version, as reported by ``ecsjobs --version``

### Installation Method

How was ecsjobs installed (provide as much detail as possible, ideally
...
that ecsjobs is running in, as well as your operating system type and version.

### Actual Output

```
Paste here the output of ecsjobs (including the command used to run it),
